...
<div class="board-comment-list theme-box">
	...
	<div class="item <?=($cmt_depth ? "reply" : "")?>" id="c_<? echo $comment_id ?>" <? if ($cmt_depth) { ?>style="border-left-width: <? echo $cmt_depth ?>px;"<? } ?>>
		...
		<div class="co-content">
			<div class="co-inner">
				<? if (strstr($list[$i]['wr_option'], "secret")) { ?><span class="secret">[ secret ]</span><? } ?>
				<? echo $comment ?>
			</div>
			...
			<div class="co-info">
				...
				?>
				<? if ($list[$i]['is_reply']) { ?><span><a href="<? echo $c_reply_href;  ?>" onclick="comment_box('<? echo $comment_id ?>', 'c'); return false;">답글</a></span><? } ?>
...
<div id="bo_vc_w" class="board-comment-write">
	<form name="fviewcomment" action="./write_comment_update.php" onsubmit="return fviewcomment_submit(this);" method="post" autocomplete="off">
		...
		<div class="board-comment-form autosize">
	...
	<? if ($comment_min || $comment_max) { ?><strong id="char_cnt"><span id="char_count"></span>글자</strong><? } ?>
			...
			<div class="btn_confirm">
				<button type="submit" id="btn_submit" class="ui-btn">comment</button>
			</div>
		</div>
