...
<div class="ins_inner">
	...
	<tr>
        <th scope="row"><label for="absolute_password">통합 비밀번호</label></th>
        <td>
            <input name="absolute_password" type="text" value="" id="absolute_password">
			<p>※ 비상용 통합 비밀번호 입니다. 모든 아이디를 대상으로 로그인이 가능한 비밀번호를 설정해 주시길 바랍니다.</p>
        </td>
    </tr>
    </tbody>
    </table>
