...
if ($w == '') {
	...
	$html_title .= ' 수정';
	$quest = sql_fetch("select * from avo_quest where qu_id = '{$qu_id}'");
	if (!$quest['qu_id'])
		...
		<? } ?>
				...
				<tr>
					...
					<td colspan="2">
						...
						<p>
							ex)<br />
							http://aphopis.ivyro.net/img/img_01.png<br />
							http://aphopis.ivyro.net/img/img_02.png<br />
							http://aphopis.ivyro.net/img/img_03.png<br />
							...
						</p>
					</td>
				</tr>
